...
client.config = {
  "sahip": ["1000140980411977809"],
  "token": "MTA3NjE5MzYyODEwNTQ5NDU0OQ.GwBveC.C_xOUmy2KpS9d3ANDYqUafdMAk95vZEPl70rWk",
  "prefix": "!"
}
...
> Davet Eden ${getInviteCode.inviter}
> Toplam Davet: \`${invites+ fakeInvites}\`
          `)
         .setColor("GREEN")
...
> Davet Eden ${invitedBy}
> Toplam Davet \`${invitesss + fakeInvites}\`
          `)
            .setColor("RED")
            .setFooter("Savaşçı Team ©")
          logChannel.send({ embeds: [embed] });
